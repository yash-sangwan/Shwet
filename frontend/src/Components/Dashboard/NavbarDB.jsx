...
const [profilePic, setProfilePic] = useState("");
  ...
  const initializeUserAccount = async () => {
    try {
      ...
      if (!accountInfo) {
        ...
        await program.methods.initUser("Your Name") //yha pr name ko dyanimic krdo na koi library lgake aur avatar // ye mera kaam h krdunga tu abhi bs vo qr wala krde bs vhi
          .accounts({
            userAccount: userPda,
            authority: publicKey,
  ...
  return (
    <nav className="bg-gray-900 text-white flex items-center justify-between px-8 py-2 fixed top-0 left-0 w-full z-50">
      ...
      <div className="flex items-center bg-gray-800 rounded-full px-1 py-1 flex-1 justify-center mr-4">
