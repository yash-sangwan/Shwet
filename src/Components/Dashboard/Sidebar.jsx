        ...
        {location.pathname === "/read/notifications" ? (
          <div>
            ...
            <ul className="space-y-4 pl-2">
              <li>
                <button className="w-full text-left text-sm p-2 hover:text-black bg-primary hover:bg-secondary rounded flex items-center space-x-3">
              ...
              <li>
                <button className="w-full text-left text-sm p-2 hover:bg-gray-700 rounded flex items-center space-x-3">
                  <span>Groups</span>
                </button>
              </li>
              <li>
          ...
          <div>
            {/* Default Sidebar */}
            <div className="mb-10 pl-10">
              <button className="flex items-center space-x-2 text-white hover:bg-gray-800 p-2 rounded border-dashed border-gray-300 border">
            ...
            <ul className="space-y-4 pl-2">
              <li>
                <button className="w-full text-left text-sm p-2 bg-gray-800 hover:bg-gray-700 rounded flex items-center space-x-3">
                  <img
