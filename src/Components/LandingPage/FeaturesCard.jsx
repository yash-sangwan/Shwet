...
const FeatureCard = ({
  ...
  return (
    <>
      {/* <img src={assets.pattern} className="bg-hero-pattern absolute" /> */}
  ...
  const nftData = [
    {
      ...
      bids: 792,
      animation: {
        translateX: 30, // Move diagonally right-down
        translateY: 50, // Move diagonally right-down
      },
      zIndex: 10, // Assign zIndex for first card
    },
    {
      ...
      bids: "1.6k",
      animation: {
        translateX: -100, // Move diagonally left-up
        translateY: 10, // Move diagonally left-up
      },
      zIndex: 20, // Assign zIndex for second card
    },
  ];
